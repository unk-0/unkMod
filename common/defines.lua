...
NCountry = {
	...
	ABANDON_CORE_PRESTIGE = -5,					-- The cost of abandoning a core that some other country owns.
	...
	SETTLMENT_GROWTH_CHANCE_MULTIPLIER = 5, -- Affects chance of development increase per year if a colonist is working on Settlement Growth.
	SETTLMENT_GROWTH_CHANCE_MIN = 0.1, -- Minimum chance of increasing development for colonists promoting Settlement Growth
